...
// export type FetchDataFn = (url: string, options?: any, action?: (data: any, pages: WebPage[]) => {}) => Promise<void>;
export type FetchDataFn = (url: string, options?: any, action?: any) => Promise<void>;
